...
var (
	...
	ErrUserNotFound         = Err{HTTPCode: http.StatusNotFound, ErrorCode: 2003, Message: "user not found"}
	ErrPermissionDenied     = Err{HTTPCode: http.StatusForbidden, ErrorCode: 2004, Message: "permission denied"}
